<div id="bloc_contenu">
    ...
    <h1>Mettre à jour un administrateur</h1>

    <?php echo $this->session->flashdata('success'); ?>
    <?php
    $attributes = array("class" => "form-horizontal", "id" => "adminaupdateform", "name" => "adminupdateform");
    ...
    <table class="tableau_formulaire" id="tableau_form_administrateurs">
        <tr>
            ...
            <td class="col_input">
                <input class="form-control" id="txt_nom" name="txt_nom" placeholder="Nom" type="text"  value="<?php echo($user['user_name']) ?>"  />
        ...
        <tr>
            ...
            <td class="col_input">
                <input class="form-control" id="txt_prenom" name="txt_prenom" placeholder="Prénom" type="text" value="<?php echo($user['user_surname']) ?>" />
        ...
        <tr>
            ...
            <td class="col_input">
                <input class="form-control" id="txt_email" name="txt_login" placeholder="Login" type="text" value="<?php echo($user['login']) ?>" />
        ...
        <tr>
            ...
            <td class="col_input">
                <input class="form-control" id="txt_email" name="txt_password" placeholder="Mot de passe" type="password" value="<?php echo($user['password']) ?>" />
        ...
        <tr>
            ...
            <td class="col_input">
                ...
                <input type="checkbox" <?= $checked ?> name="txt_active" value="1" />
            </td>
        </tr>
